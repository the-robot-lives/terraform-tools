...
OpenTofu/Terragrunt helpers coupled to trl-infra terraform/ stacks (init → infra → infra-services → platform/*; binary is OpenTofu per root.hcl).
